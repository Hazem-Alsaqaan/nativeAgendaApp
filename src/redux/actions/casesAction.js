...
export const showCasesByDate = createAsyncThunk("casesSlice/showCasesByDate", async(item)=>{
    try{
...
// add new case 
export const addNewCases = createAsyncThunk("casesSlice/addNewCases", async(item)=>{
    try{
...
// update cases
export const updateCases = createAsyncThunk("casesSlice/updateCases", async(item)=>{
    try{
...
// delete cases 
export const deleteCases = createAsyncThunk("casesSlice/deleteCases", async(item)=>{
    try{
...
// show single case
export const ShowSingleCase = createAsyncThunk("casesSlice/showSingleCase", async(item)=>{
    try{
