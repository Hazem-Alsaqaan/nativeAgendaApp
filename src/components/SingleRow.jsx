        ...
        <>
            <ScrollView horizontal contentContainerStyle={tw`flex flex-row-reverse justify-center items-center p-5  bg-transparent`}>
                ...
                <View style={tw`w-50 h-32 bg-sky-50 rounded-lg mx-1 flex items-center border-solid border-2 border-gray-200 shadow-2xl`}>
                    <Text style={tw`w-40 h-10 rounded bg-sky-400     px-2 py-1 text-white text-xl text-center font-bold -mt-3 shadow-2xl`}>المدعى</Text>
                    <View style={tw`w-full flex-1`}>
                        <Text style={tw`mt-2 p-1 text-black text-base font-bold text-center`}>{item?.plaintiff}</Text>
                    </View>
                </View>
                <View style={tw`w-50 h-32 bg-cyan-50 rounded-lg mx-1 flex items-center border-solid border-2 border-gray-200 shadow-2xl`}>
                    <Text style={tw`w-40 h-10 rounded bg-cyan-500      px-2 py-1 text-white text-xl text-center font-bold -mt-3 shadow-2xl`}>المدعى عليه</Text>
                    <View style={tw`w-full flex-1`}>
                        <Text style={tw`mt-2 p-1 text-black text-base font-bold text-center `}>{item?.defendant}</Text>
                    </View>
                </View>
                <View style={tw`w-50 h-32 bg-red-50 rounded-lg mx-1 flex items-center border-solid border-2 border-gray-200 shadow-2xl`}>
                    <Text style={tw`w-40 h-10 rounded bg-red-500     px-2 py-1 text-white text-xl text-center font-bold -mt-3 shadow-2xl`}>نوع الدعوى</Text>
                    <View style={tw`w-full flex-1`}>
                        <Text style={tw`mt-2 p-1 text-black text-base font-bold text-center `}>{item?.typeCase}</Text>
                    </View>
                </View>
                <View style={tw`w-120 h-32 bg-indigo-50 rounded-lg mx-1 flex items-center  border-solid border-2 border-gray-200 shadow-2xl`}>
                    <Text style={tw`w-40 h-10 rounded bg-indigo-500     px-2 py-1 text-white text-xl text-center font-bold -mt-3 shadow-2xl`}>تاريخ الجلسات</Text>
                    {item.sessions
                                ...
                                <View style={tw`bg-indigo-100 flex-row justify-between border-b-[1px] border-solid border-slate-100`} key={singleSession._id}>
                                    <View style={tw`flex-row items-center justify-center`}>
                                        <TouchableOpacity onPress={() => removeSession(singleSession._id)} style={tw`bg-violet-500 m-0.5 rounded py-0.5 px-2`}>
                                            <Text style={tw`text-white text-base font-bold`}>حذف</Text>
                                        </TouchableOpacity>
                                        ...
                                        <TouchableOpacity onPress={() => selectedSessionToEdit(singleSession)} style={tw`bg-purple-500 m-0.5 rounded py-0.5 px-2`}>
                                            <Text style={tw`text-white text-base font-bold`}>تعديل</Text>
                                        </TouchableOpacity>
                                    </View>
                ...
                <View style={tw`w-50 h-32 bg-blue-50 rounded-lg mx-1 flex items-center border-solid border-2 border-gray-200 shadow-2xl`}>
                    <Text style={tw`w-40 h-10 rounded bg-blue-500  px-2 py-1 text-white text-xl text-center font-bold -mt-3 shadow-2xl `}>حذف-تعديل</Text>
